...
![ExchangeRate 随机点缺失对比](figures/r4/fig1_exchange_random_point.png)
*图 1a：ExchangeRate 随机点缺失 — 两阶段基线 vs R3 缺失感知方法*

![ExchangeRate 连续片段缺失对比](figures/r4/fig1_exchange_continuous_segment.png)
...
![iTransformer(add) 随机点缺失改善率热力图](figures/r4/fig2_mask_aware_iTrans_random_point.png)
*图 2a：iTransformer(add) MSE 变化率 — 随机点缺失*

![iTransformer(add) 连续片段缺失改善率热力图](figures/r4/fig2_mask_aware_iTrans_continuous_segment.png)
...
![PatchTST(add) 随机点缺失改善率热力图](figures/r4/fig2_mask_aware_PatchTST_random_point.png)
*图 2c：PatchTST(add) MSE 变化率 — 随机点缺失*

![PatchTST(add) 连续片段缺失改善率热力图](figures/r4/fig2_mask_aware_PatchTST_continuous_segment.png)
...
![方法胜出矩阵 — 随机点缺失](figures/r4/fig3_winner_random_point.png)
*图 3a：每个条件下 MSE 最优方法 — 随机点缺失*

![方法胜出矩阵 — 连续片段缺失](figures/r4/fig3_winner_continuous_segment.png)
...
![缺失率趋势 — 随机点缺失](figures/r4/fig4_trend_random_point.png)
*图 4a：各方法 MSE 随缺失率变化 — 随机点缺失（4 个数据集）*

![缺失率趋势 — 连续片段缺失](figures/r4/fig4_trend_continuous_segment.png)
*图 4b：各方法 MSE 随缺失率变化 — 连续片段缺失（4 个数据集）*

### 4.4 两阶段 vs 缺失感知 MSE 差值

![MSE 差值 — 随机点缺失](figures/r4/fig5_delta_random_point.png)
*图 5a：缺失感知方法 MSE 减去最优两阶段方法 MSE — 随机点缺失（负值 = 缺失感知更好）*

![MSE 差值 — 连续片段缺失](figures/r4/fig5_delta_continuous_segment.png)
...
![CoIFNet 变体消融](figures/r4/fig6_coifnet_ablation.png)
...
![MissTSM 分组 query 对比](figures/r4/fig7_grouped_query.png)
...
![PatchTST(add) 对比](figures/r4/fig8_patchtst_add.png)
...
![方法 × 数据集 × 缺失率区间 综合热力图](figures/r4/fig9_comprehensive_heatmap.png)
*图 9：方法在不同数据集和缺失率区间下的平均 MSE 热力图*

![方法排名雷达图](figures/r4/fig10_radar.png)
